...
// import SimplebarReactClient from "./neededforTopBar/SimplebarReactClient";
  ...
  return (
    <div className="hs-dropdown relative inline-flex [--placement:bottom-right]">
      <button
        ...
        type="button"
        className="hs-dropdown-toggle inline-flex h-10 w-10 flex-shrink-0 items-center justify-center gap-2 rounded-full bg-default-100 align-middle text-xs font-medium text-default-700 transition-all hover:text-customOrange bg-customLightBlue bg-opacity-10"
      >
        <LuBell size={24} />
        <span className="absolute end-1 top-0 h-4 w-4 animate-ping rounded-full bg-customOrange" />
        <span className="absolute end-1 top-0 h-4 w-4 rounded-full bg-customOrange text-xs font-medium text-white">
          2
        </span>
      </button>
      <div className="hs-dropdown-menu duration mt-2 hidden min-w-[20rem] rounded-lg border border-default-200 bg-white opacity-0 shadow-md transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
        ...
        <div className="h-80 border-y border-dashed border-default-200 p-4">
