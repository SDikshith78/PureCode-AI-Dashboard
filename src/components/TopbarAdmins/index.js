      ...
      <nav className="flex w-full items-center gap-4 px-6">
        ...
        <div className="hidden lg:flex">
          <div className="relative hidden lg:flex">
            <input
              type="search"
              className="block w-64 rounded-full border-default-100 bg-customLightBlue bg-opacity-5 py-2.5 pe-4 ps-12 text-sm text-default-600 focus:border-customOrange focus:ring-customOrange"
