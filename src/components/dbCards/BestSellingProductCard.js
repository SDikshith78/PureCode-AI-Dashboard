...
import { calculatedPrice } from "../../helpers/product";
import { currentCurrency } from "../../helpers/constants";
...
const BestSellingProductCard = ({ product }) => {
  ...
  return (
    <a
      href="/BestSellingProductCard"
      className="overflow-hidden rounded-lg border border-default-200 p-4 transition-all duration-300 hover:border-customOrange"
    >
