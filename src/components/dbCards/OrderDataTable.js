        ...
        <div className="inline-block min-w-full align-middle">
          <div className="overflow-hidden">
            <table className="w-full divide-y divide-default-200">
              <thead className="bg-customLightBlue bg-opacity-5">
                      ...
                      {columns.map((column) => {
                        ...
                        if (column.key === "dish_id") {
                          ...
                          return (
                            <td
                              key={tableData + idx}
                              className="whitespace-nowrap px-6 py-4 text-sm font-medium text-default-500 hover:text-customOrange"
                            >
                              <a href={`/admin/orders/${row.id.slice(1)}`}>
                                {row.id.toUpperCase()}
                              </a>
                            </td>
                          );
